...
//
    ...
    var is_fb = ((agt.indexOf('mozilla/5')!=-1) && (agt.indexOf('spoofer')==-1) &&
				 ...
				 /*
	Firefox 1.5 does not set navigator.vendor to "Firefox", so checking the user agent is done instead.
	Firefox 1.0 DOES set navigator.vendor to "Firefox", so version checking can happen in that regard.
	-- Greg Bueno, 1/9/06
	Per Greg, I am adding a note that the update (#0051202) listed in the notes at the top of this file addresses
	the issue in this note. The issue Greg noted no longer applies. --April Brinkmeyer, 11/20/07
	*/
    var is_fx = ((agt.indexOf('mozilla/5')!=-1) && (agt.indexOf('spoofer')==-1) &&
                 (agt.indexOf('compatible')==-1) && (agt.indexOf('opera')==-1)  &&
                 (agt.indexOf('webtv')==-1) && (agt.indexOf('hotjava')==-1)     &&
                 (is_gecko) && ((navigator.vendor=="Firefox")||(agt.indexOf('firefox')!=-1)));
	var is_fx10 = ((agt.indexOf('mozilla/5')!=-1) && (agt.indexOf('spoofer')==-1) &&
                 (agt.indexOf('compatible')==-1) && (agt.indexOf('opera')==-1)  &&
                 (agt.indexOf('webtv')==-1) && (agt.indexOf('hotjava')==-1)     &&
